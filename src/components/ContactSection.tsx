...
const ContactSection: React.FC<{ package: string }> = (props) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (props.package) {
            // If the Package prop is available, include it in the message
            messageContent += `\n\nSelected Package Type: ${props.package}`;
        }
    ...
    useEffect(() => {
        if (formData.show) {
            const timeoutId = setTimeout(() => {
                setFormdata((prevFormData) => ({ ...prevFormData, show: false }));
            ...
            <div className="container flex flex-col min-h-screen px-4 py-4 mx-auto">
                <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
                    <div className="text-white lg:w-1/2 lg:mx-6">
                        ...
                        <p className="max-w-xl mt-6">Ask us anything and we would love to hear from you</p>
