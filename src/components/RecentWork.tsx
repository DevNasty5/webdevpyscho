    ...
    <div id='Rw' className='w-full relative' style={{ backgroundColor: '#e1eaf4' }}>
      <div className="container p-6 sm:p-12 md:p-24">
        ...
        <div className="mx-auto w-full sm:w-2/3 md:w-1/3 lg:w-1/4 xl:w-1/6 shadow-2xl border bg-black rounded-lg p-2 hover:-translate-y-2 hover:shadow-4xl duration-300">
          ...
          <Image src={Html} alt='html' className='absolute right-2 top-2'>

          </Image>
          <Image src={Php} alt='php' className='absolute left-3 top-14'>
        ...
        <div className="justify-center items-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4 sm:gap-5 md:gap-7 md:py-8 md:px-16 md:my-10">
          ...
          <Image src={Css} alt='css' className='absolute left-6'>
